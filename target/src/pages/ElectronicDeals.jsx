...
import ElectronicDealsImage from "../images/electronic-deals.webp";
...
function ElectronicDeals() {
  ...
  useEffect(() => {
    const getAllElectronicProducts =
      process.env.REACT_APP_GET_PRODUCT_BY_PRODUCT_TYPE_ELECTRONICS;
    axios
      .get(getAllElectronicProducts)
      .then((response) => {
  ...
  return (
    <>
        ...
        <Link to="../Electronic-Deals">
          <Categories image={ElectronicDealsImage} description="Electronic Deals" />
        </Link>
