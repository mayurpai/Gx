...
import ToyDealsImage from "../images/toy-deals.webp";
...
function ToyDeals() {
  ...
  document.title = "Toy Deals : Target";
  const { REACT_APP_GET_PRODUCT_BY_ID } = process.env;

  useEffect(() => {
    const getAllToyProducts =
      process.env.REACT_APP_GET_PRODUCT_BY_PRODUCT_TYPE_TOYS;
    axios
  ...
  return (
    <>
      ...
      <div className="categories-flex">
        ...
        <Link to="../Toy-Deals">
          <Categories image={ToyDealsImage} description="Toy Deals" />
        </Link>
