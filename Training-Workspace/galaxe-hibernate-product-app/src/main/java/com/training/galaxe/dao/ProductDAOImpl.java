...
public class ProductDAOImpl implements ProductDAO {
  ...
  public Product getProduct(int productID) {
    ...
    // This Won't Affect The Database As The State Is Still In Transient And Is Local
    ...
    session.close();
    sessionFactory.close();
    // This Line Won't Either Affect The Database, But Locally Update The Objects Price
    product.setPrice(10000);
    System.out.println(product.getPrice()); // 10000 -> This Is Returned To The Caller But Not Database As The Connection Is Already Closed
    return product;
  }
