...
function init() {
  ...
  var flightNine = new Flight(9, "7DJ9", "VistaraAirlines");
  ...
  document.getElementById("flightNameFour").innerHTML =flightScheduleFour.flight;
  document.getElementById("flightNumberFour").innerHTML =flightFour.flightNumber;
  document.getElementById("departTimeFour").innerHTML =flightScheduleFour.departTime;
  document.getElementById("durationFour").innerHTML =flightScheduleFour.duration;
  document.getElementById("reachTimeFour").innerHTML = flightScheduleFour.reachTime;
  ...
  document.getElementById("flightNameFive").innerHTML =flightScheduleFive.flight;
  document.getElementById("flightNumberFive").innerHTML =flightFive.flightNumber;
  document.getElementById("departTimeFive").innerHTML =flightScheduleFive.departTime;
  document.getElementById("durationFive").innerHTML =flightScheduleFive.duration;
  document.getElementById("reachTimeFive").innerHTML = flightScheduleFive.reachTime;
  ...
  document.getElementById("departTimeSix").innerHTML =flightScheduleSix.departTime;
  document.getElementById("durationSix").innerHTML =flightScheduleSix.duration;
  document.getElementById("reachTimeSix").innerHTML = flightScheduleSix.reachTime;
  ...
  document.getElementById("flightNameSeven").innerHTML =flightScheduleSeven.flight;
  document.getElementById("flightNumberSeven").innerHTML =flightSeven.flightNumber;
  document.getElementById("departTimeSeven").innerHTML =flightScheduleSeven.departTime;
  document.getElementById("durationSeven").innerHTML =flightScheduleSeven.duration;
  document.getElementById("reachTimeSeven").innerHTML = flightScheduleSeven.reachTime;
  ...
  document.getElementById("flightNameEight").innerHTML =flightScheduleEight.flight;
  document.getElementById("flightNumberEight").innerHTML =flightEight.flightNumber;
  document.getElementById("departTimeEight").innerHTML =flightScheduleEight.departTime;
  document.getElementById("durationEight").innerHTML =flightScheduleEight.duration;
  document.getElementById("reachTimeEight").innerHTML = flightScheduleEight.reachTime;
  ...
  document.getElementById("flightNameNine").innerHTML =flightScheduleNine.flight;
  document.getElementById("flightNumberNine").innerHTML =flightNine.flightNumber;
  document.getElementById("departTimeNine").innerHTML =flightScheduleNine.departTime;
  document.getElementById("durationNine").innerHTML =flightScheduleNine.duration;
  document.getElementById("reachTimeNine").innerHTML = flightScheduleNine.reachTime;
  ...
  document.getElementById("departTimeTen").innerHTML =flightScheduleTen.departTime;
  document.getElementById("durationTen").innerHTML =flightScheduleTen.duration;
  document.getElementById("reachTimeTen").innerHTML = flightScheduleTen.reachTime;
