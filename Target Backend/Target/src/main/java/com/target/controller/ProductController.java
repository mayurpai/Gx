...
//	Optional<Cart> cart;
	...
	public List<Product> getAllProducts() throws ProductNotFound, Exception {
		try {
			...
			throw new ProductNotFound("Sorry For The Inconvenience, No Products Found");
		} catch (Exception e) {
			throw new Exception();
		}
	}
	...
	public List<Product> getAllProductsByProductType(@PathVariable ProductType productType)
		...
		try {
			...
			throw new ProductNotFound("Sorry For The Inconvenience, No Product Found");
		} catch (Exception e) {
			throw new Exception();
		}
		return product;
	...
	public List<Product> getAllProductsByProductBrand(@PathVariable String productBrand)
		...
		try {
			...
			throw new ProductNotFound("Sorry For The Inconvenience, No Product With Brand " + productBrand + " Found");
		} catch (Exception e) {
			throw new Exception();
		}
		return product;
	...
	public List<Product> getAllProductsByProductName(@PathVariable String productName)
		...
		try {
			...
			throw new ProductNotFound("Sorry For The Inconvenience, No Product Found For " + productName);
		} catch (Exception e) {
			throw new Exception();
		}
		return product;
